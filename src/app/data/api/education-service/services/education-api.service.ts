...
export class EducationApiService extends BaseService {
	...
	/**
	 * The method attempts to add the user education.
	 *
	 ...
	 * This method sends `application/json` and handles request body of type `application/json`.
	 */
	createEducation(params: { body: CreateEducationRequest }): Observable<OperationResultResponse> {
	...
	/**
	 * Remove the specified education by id.
	 *
	 * This method provides access to the full `HttpResponse`, allowing access to response headers.
