...
export class UserService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public editUserPost(body: UserRequest, observe?: 'body', reportProgress?: boolean): Observable<boolean>;
    public editUserPost(body: UserRequest, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<boolean>>;
    public editUserPost(body: UserRequest, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<boolean>>;
    public editUserPost(body: UserRequest, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<boolean>('post',`${this.basePath}/editUser`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
