...
@NgModule({
	...
	exports: [],
	declarations: [],
	providers: [NewsApiService, ChannelApiService, ChannelApiService, TagApiService, ApiConfiguration],
})
export class NewsApiModule {
	...
	constructor(@Optional() @SkipSelf() parentModule: NewsApiModule, @Optional() http: HttpClient) {
		if (parentModule) {
