...
export class UserRightsApiService extends BaseService {
	 ...
	 */
	static readonly CreatePath = '/userrights/create';
	...
	create$Response(params: {
		...
		const rb = new RequestBuilder(this.rootUrl, UserRightsApiService.CreatePath, 'post');
		if (params) {
	 ...
	 */
	static readonly RemoveRightsFromUserPath = '/userrights/remove';
	...
	removeRightsFromUser$Response(params: {
		...
		const rb = new RequestBuilder(this.rootUrl, UserRightsApiService.RemoveRightsFromUserPath, 'delete');
		if (params) {
			rb.query('userId', params.userId, {});
			rb.body(params.body, 'application/json');
		}
