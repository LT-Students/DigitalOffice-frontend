...
import { EducationFormApiService } from './services/education-form-api.service';
import { EducationTypeApiService } from './services/education-type-api.service';
...
@NgModule({
  ...
  providers: [
    EducationApiService,
    EducationFormApiService,
    EducationTypeApiService,
    ImageApiService,
    ApiConfiguration
  ],
})
export class EducationApiModule {
  ...
  constructor( 
    @Optional() @SkipSelf() parentModule: EducationApiModule,
