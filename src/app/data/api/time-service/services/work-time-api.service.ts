...
export class WorkTimeApiService extends BaseService {
	 ...
	 * This method sends `application/json` and handles request body of type `application/json`.
	 */
	createWorkTime(params: { body: CreateWorkTimeRequest }): Observable<OperationResultResponse> {
	...
	findWorkTimes(params?: {
		...
		return this.findWorkTimes$Response(params).pipe(
			map(
				(r: StrictHttpResponse<FindResultResponseWorkTimeResponse>) =>
					r.body as FindResultResponseWorkTimeResponse
			)
		);
	}
