...
export class AddProjectUsersService {
	constructor(private filterService: FilterService, private projectUsers: UserApiService) {}

	public getTableData(idsToHide: string[], dataSource: AddUsersDataSource): ColumnDef[] {
		return [
			{
				type: 'checkboxCell',
				field: 'checkbox',
	...
	public addUsers(projectId: string, users: ProjectUserInfo[]): Observable<any> {
		...
		return this.projectUsers.createProjectUsers({ body: { projectId, users: newUsers } });
	}
