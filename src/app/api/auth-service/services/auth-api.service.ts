...
export class AuthApiService extends BaseService {
	 ...
	 */
	login$Response(params: { body: AuthenticationRequest }): Observable<StrictHttpResponse<AuthenticationResponse>> {
	 ...
	 * This method sends `application/json` and handles request body of type `application/json`.
	 */
	login(params: { body: AuthenticationRequest }): Observable<AuthenticationResponse> {
	 ...
	 * This method sends `application/json` and handles request body of type `application/json`.
	 */
	refresh$Response(params: { body: RefreshRequest }): Observable<StrictHttpResponse<AuthenticationResponse>> {
	 ...
	 * This method sends `application/json` and handles request body of type `application/json`.
	 */
	refresh(params: { body: RefreshRequest }): Observable<AuthenticationResponse> {
