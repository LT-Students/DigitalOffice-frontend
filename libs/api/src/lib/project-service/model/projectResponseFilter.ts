...
export interface ProjectResponseFilter { 
    /**
     * The project's title.
     */
    name?: string;
    workersUsersIds?: WorkersUsersIds;
    /**
     * Id of the department that funds the project.
     */
    departmentId?: string;
    /**
     * Analogue of the deadline or the IsCompleted mark. Allows to search for the completed projects.
     */
    isActive?: boolean;
}