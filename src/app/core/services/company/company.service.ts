...
export class CompanyService {
	...
	public getCompany(companyId: string, params?: { includeoffices: boolean }): Observable<Company> {
		return this._companyService
			.getCompany({ companyId: companyId, ...params })
			.pipe(switchMap((res) => of(new Company(res.body as CompanyInfo))));
	}
