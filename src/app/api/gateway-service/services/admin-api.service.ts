...
import { FindOperationResultResponse } from '../models/find-operation-result-response';
...
export class AdminApiService extends BaseService {
	 ...
	 */
	editAdmin$Response(params: { body: Array<string> }): Observable<StrictHttpResponse<OperationResultResponse>> {
	 ...
	 * This method sends `application/json` and handles request body of type `application/json`.
	 */
	editAdmin(params: { body: Array<string> }): Observable<OperationResultResponse> {
	...
	installApp$Response(params?: {
	...
	}): Observable<StrictHttpResponse<FindOperationResultResponse>> {
		...
		return this.http
			...
			.pipe(
				filter((r: any) => r instanceof HttpResponse),
				map((r: HttpResponse<any>) => {
					return r as StrictHttpResponse<FindOperationResultResponse>;
				})
			);
	}
	 ...
	 * This method sends `application/json` and handles request body of type `application/json`.
	 */
	installApp(params?: { body?: InstallAppRequest }): Observable<FindOperationResultResponse> {
		return this.installApp$Response(params).pipe(
			map((r: StrictHttpResponse<FindOperationResultResponse>) => r.body as FindOperationResultResponse)
		);
	}
}
