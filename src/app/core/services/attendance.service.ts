...
export class AttendanceService {
  ...
  private readonly _recommendedTime = new BehaviorSubject<Time>(
    this.getRecommendedTime(this.datePeriod)
  );
  ...
  public getRecommendedTime(
    ...
    if (
      datePeriod.endDate &&
      this.dateService.isSameDay(datePeriod.startDate, datePeriod.endDate)
    ) {
