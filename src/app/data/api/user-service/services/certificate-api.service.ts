...
import { IEditCertificateRequest } from '@app/services/user/certificate.service';
...
export class CertificateApiService extends BaseService {
  ...
  /**
   * The method attempts to add the certificate. The user must have the rights to add education to other users - Add/Edit/Remove users.
   *
  ...
  /**
   * Remove the specified certificate by id. The user must have the rights to remove certificate to other users - Add/Edit/Remove users.
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
